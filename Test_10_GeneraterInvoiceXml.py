...
class CreateXmlForInvoice():
    ...
    def create_invoice(self):
        ...
        self.invoice.id = "MUH2023000018182"
        ...
        file = open("Files/XML_GENERATER/invoice_template_context.txt", 'r')
        data = file.read()
        ...
        file = open('Files/XML_GENERATER/invoice_xml.xml', 'w', encoding="utf-8")
        file.write(data)
        file.close()
