...
class CreateXmlForCreditNote():
    ...
    def create_creditnote(self):
        ...
        self.creditNote.id = "MUH2023000018182"
        ...
        additionalDocumentReference.issue_date = "2023-10-20"
        ...
        additionalDocumentReference_1.issue_date = "2023-10-20"
        ...
        file = open("Files/XML_GENERATER/creditNote_template_context.txt", 'r')
        data = file.read()
        ...
        file = open('Files/XML_GENERATER/creditNote_xml.xml', 'w', encoding="utf-8")
        file.write(data)
        file.close()
